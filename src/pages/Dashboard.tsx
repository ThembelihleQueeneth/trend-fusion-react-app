                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-[10px] uppercase text-slate-500 border-b border-white/5">
                      ...
                      <th className="px-3 py-4 text-right cursor-pointer select-none" onClick={() => handleSort("price_change_percentage_24h_in_currency")}>
                        <span className="inline-flex items-center justify-end gap-1">24h <SortIcon col="price_change_percentage_24h_in_currency" /></span>
                      </th>
